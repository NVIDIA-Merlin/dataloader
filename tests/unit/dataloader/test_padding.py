...
from merlin.dataloader.ops.padding import Padding  # noqa
...
def test_padding(cpu):
    ...
    # should this column be considered fix even though we dont know the number of entries per batch?
    # assert col_schema.shape.is_fixed
